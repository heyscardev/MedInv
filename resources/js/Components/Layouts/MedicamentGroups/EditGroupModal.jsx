...
export default ({ group, groups, open, onClose, onSuccess }) => {
    ...
    <Modal {...{ open, onClose }}>
      <div style={{ textAlign: "center" }}>
        ...
        <Typography variant="h5" color="secondary.dark">
          {!group ? formatMessage({ id: "newMedicamentGroup" }) : formatMessage({ id: "updateMedicamentGroup" })}
        </Typography>
      </div>
      <Form
              ...
              <Grid item xs={12} sm={12}>
                <InputText
                  ...
                  validate={composeValidators(required, (value) =>
                    _.find(groups, (un) => un.name === value) && (!unit || unit.name !== value ) ? "fieldError.unique" : null
                  )}
      ...
      >
        ...
        <Button startIcon={<Save />} variant="contained" type="submit" sx={{ color: "#fff" }} form="groupForm">
          Guardar
        </Button>
      </DialogActions>
    </Modal>
