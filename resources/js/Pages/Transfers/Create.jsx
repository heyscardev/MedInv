...
export default ({ medicaments, moduleToTransfers, moduleFromTransfers, moduleSelected,selectedMedicaments, can, ...props }) => {
  ...
  return (
    <Fragment>
      ...
      <Form
        ...
        initialValues={{ moduleReceive: null, moduleSend: moduleSelected,medicaments:selectedMedicaments, description: null }}
        validate={(values) => {
          const error = {};
              ...
              {({ fields }) => (
                <Stack spacing={2} padding={4}>
                  <Stack bgcolor="white.main" borderRadius={2} padding={1} gap={2}>
                    ...
                    <Divider />
                    <Grid container alignItems="center" justifyContent="center" rowGap={2} columnSpacing={2}>
                      ...
                      <Grid item xs={12} sm={10} md={2}>
                        <Stack alignItems="center">
                          <Hidden mdDown>
                            <Stack direction="row">
                              <KeyboardDoubleArrowRightIcon color="primary" sx={{ fontSize: "50px" }} />
                              <KeyboardDoubleArrowRightIcon color="primary" sx={{ fontSize: "50px" }} />
                              <KeyboardDoubleArrowRightIcon color="primary" sx={{ fontSize: "50px" }} />
                            </Stack>
                          </Hidden>
                          <Hidden mdUp>
                            <Stack marginLeft={5}>
                              <KeyboardDoubleArrowDownIcon color="primary" sx={{ fontSize: "50px" }} />
                              <KeyboardDoubleArrowDownIcon color="primary" sx={{ fontSize: "50px" }} />
                            </Stack>
                          </Hidden>
                        </Stack>
                      ...
                      renderOption={(props, option) => (
                        <Box {...props} key={option.id} component="li">
                          ...
                          <span style={{ color: "red", marginLeft: "3px" }}>
                            <IntlMessage id="available" />: {option.pivot.quantity_exist}
                          </span>
                        </Box>
                      )}
                      onChange={(e, value) => {
                            ...
                            <TableCell align="center" width={200}>
                              <InputText
                                ...
                                validate={composeValidators(
                                  required,
                                  lessOrEqualThanValue(itemMed.pivot.quantity_exist),
                                ...
                                errorValues={{
                                  ...
                                  lessOrEqualThanValue2: itemMed.pivot.quantity_exist,
                                }}
                                onlyNumbers
                              />
                            </TableCell>
                            <TableCell align="center">
                              <CellNumberBox value={itemMed.pivot.quantity_exist} />
                            </TableCell>
                            <TableCell>
                              <CellNumberBox
                                value={
                                  itemMed.pivot.quantity_exist - _.get(values, `${fieldName}.quantity`, 0) <= 0
                                    ? 0
                                    : itemMed.pivot.quantity_exist - _.get(values, `${fieldName}.quantity`, 0)
                                }
                              />
                            </TableCell>
                            <TableCell align="center">
                  ...
                  <Button
                    disabled={!values.medicaments || values.medicaments.maxLength <= 0}
                    variant="contained"
                    color="primary"
                    type="submit"
                  >
                  ...
                  <SelectionModuleModal
                    ...
                    onSelect={(value) => {
                      if (moduleSelected && moduleSelected.id === value.id) return null;
